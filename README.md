...
本專案是一個基於 Google Apps Script 建構的網頁應用程式，旨在協助學校管理四技二專甄選入學的學生志願調查作業。系統允許學生線上填報志願，老師可查詢班級學生的填報狀況，管理員則可透過 Google Sheets 後台進行相關設定與資料管理。系統整合了電子郵件通知功能，當學生完成志願選填後，會自動寄送確認信函。
...
* 管理統測報名資料、校系科(組)學程資料、可報名之系科組學程數、老師名單。
* 匯出報名用 CSV 檔。
* 查看學生填寫日誌。
* 清除系統快取。
* 查看各志願選填人數統計。
